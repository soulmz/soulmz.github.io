...
```shell
[root@kubernetes-master ~]# kubectl create deployment nginx --image=nginx:alpine
deployment.apps/nginx created
[root@kubernetes-master ~]# kubectl get pods -l app=nginx -o wide
NAME                     READY   STATUS    RESTARTS   AGE   IP           NODE          NOMINATED NODE
nginx-65d5c4f7cc-fgj2f   1/1     Running   0          52s   10.244.6.2   gtdocker052   <none>
nginx-65d5c4f7cc-lq585   1/1     Running   0          23s   10.244.8.2   gtdocker054   <none>
[root@kubernetes-master ~]# kubectl scale deployment nginx --replicas=2
...
# 查看暴露的服务端口
[root@kubernetes-master ~]# kubectl get services nginx
NAME    TYPE       CLUSTER-IP      EXTERNAL-IP   PORT(S)        AGE
nginx   NodePort   10.98.173.217   <none>        80:30879/TCP   9s


# 可以通过任意 NodeIP:Port 在集群外部访问这个服务，本示例中部署的2台集群IP分别是113.106.202.52和113.106.202.53、113.106.202.54
curl http://113.106.202.52:30879
curl http://113.106.202.53:30879
curl http://113.106.202.54:30879
...
```shell
[root@kubernetes-master ~]# kubectl run -it curl --image=radial/busyboxplus:curl
